...
test.only('actual_jamsFoundation_page', {tag: ['@actual']}, async ({ page }, testInfo) => {
  
    const url = urls.base +"/jamsfoundation";
  ...
  const screenshotName = `${projectName}-jamsFoundationPage.png`;
