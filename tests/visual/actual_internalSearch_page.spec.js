...
test('actual_internalSearch_page', {tag: ['@visual']}, async ({ page }, testInfo) => {
  
    const url = urls.base +"/search?q=aviation";
  ...
  const screenshotName = `${projectName}-internalSearchPage.png`;
