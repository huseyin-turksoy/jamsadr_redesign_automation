...
test('actual_seniorDetail_page', {tag: ['@visual']}, async ({ page }, testInfo) => {
  
    const url = urls.base +"/about/jams-senior-management/kimberly-taylor";
  ...
  const screenshotName = `${projectName}-seniorDetailPage.png`;
