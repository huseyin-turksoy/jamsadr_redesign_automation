...
test('actual_eventsDetail_page', {tag: ['@visual']}, async ({ page }, testInfo) => {
  
    const url = urls.base +"/events/2026/national-academy-of-arbitrators-naa-southwestrockies-region";
  ...
  const screenshotName = `${projectName}-eventsDetailPage.png`;
