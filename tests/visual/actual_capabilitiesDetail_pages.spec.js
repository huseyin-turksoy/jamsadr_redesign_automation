...
const uris =['/capabilities/appellate', 
             '/capabilities/engineering-construction',
...
test('actual_capabilities_details_page_' + uri.split('/')[2], {tag: ['@visual']}, async ({ page }, testInfo) => {
