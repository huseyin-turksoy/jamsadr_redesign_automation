...
test('actual_seniorManagement_page', {tag: ['@actual']}, async ({ page }, testInfo) => {
  
    const url = urls.base +"/about/senior-management";
  ...
  const screenshotName = `${projectName}-seniorManagementPage.png`;
